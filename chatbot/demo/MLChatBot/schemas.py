...
validators = {
    ('ask', 'GET'): {'args': {'required': [], 'properties': {'expression': {'type': 'string'}}}},
}

filters = {
    ('ask', 'GET'): {200: {'headers': None, 'schema': {'type': 'string', 'example': 'Hello Human! I am example string.'}}, 400: {'headers': None, 'schema': {'type': 'string', 'example': 'Sorry I did not understand your request'}}},
}
